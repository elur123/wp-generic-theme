...
/**
 * Title: About Split
 * Slug: medspastarter/about-split
 * Categories: medspastarter
 * Description: Two-column about section with clinic image and credentials.
 * Keywords: about, clinic, doctor, credentials, trust
 */
?>
...
<!-- wp:column {"width":"50%"} -->
<div class="wp-block-column" style="flex-basis:50%">
<!-- wp:paragraph {"style":{"typography":{"fontSize":"0.75rem","fontWeight":"600","letterSpacing":"0.1em","textTransform":"uppercase"},"spacing":{"margin":{"bottom":"0.75rem"}}},"textColor":"primary"} -->
<p class="has-primary-color has-text-color" style="font-size:0.75rem;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.75rem">About Our Clinic</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":2,"style":{"typography":{"fontFamily":"var(--wp--preset--font-family--heading)","fontSize":"clamp(1.75rem,3.5vw,2.5rem)"},"spacing":{"margin":{"top":"0","bottom":"1rem"}}}} -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-primary-background-color has-white-color has-background has-text-color wp-element-button" href="#" style="border-radius:9999px;padding-top:0.875rem;padding-right:1.75rem;padding-bottom:0.875rem;padding-left:1.75rem">Meet Our Team</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
